...
/**
 * GrpcQueryGeneratorTest is using the ./record-store/src/main/proto/demo_person.proto protobuf to
 * test some queries
 */
class GrpcQueryGeneratorTest extends AbstractFDBContainer {
  ...
  void beforeAll()
    ...
    SecretKeySpec secretKey =
        new SecretKeySpec(Constants.CONFIG_ENCRYPTION_KEY_DEFAULT.getBytes(), "AES");
  ...
  public void testQuery(RecordStoreProtocol.QueryRequest request, int expectedResult) {
    ...
    List<Message> results =
        this.recordLayer.queryRecords(DatasetsLoader.DEFAULT_DEMO_TENANT, "USER", query);
    if (expectedResult == -1) {
  ...
  private Stream<Arguments> generateRequest() {
    return Stream.of(
        // all records
        Arguments.of(
            RecordStoreProtocol.QueryRequest.newBuilder().setRecordTypeName("User").build(), 100),
                                    ...
                                    RecordStoreProtocol.QueryFilterNode.newBuilder()
                                        .setFieldNode(
                                            RecordStoreProtocol.QueryFilterFieldNode.newBuilder()
                                                ...
                                                .setInt64Value(1)
                                                .setOperation(
                                                    RecordStoreProtocol.FilterOperation
        ...
        Arguments.of(
            RecordStoreProtocol.QueryRequest.newBuilder()
                ...
                .setFilter(
                    RecordStoreProtocol.QueryFilterNode.newBuilder()
                        .setOrNode(
                            RecordStoreProtocol.QueryFilterOrNode.newBuilder()
                                .addNodes(
                                    RecordStoreProtocol.QueryFilterNode.newBuilder()
                                        .setFieldNode(
                                            RecordStoreProtocol.QueryFilterFieldNode.newBuilder()
                                                ...
                                                .setInt64Value(1)
                                                .setOperation(
                                                    RecordStoreProtocol.FilterOperation.EQUALS)
                                                .build())
                                        .build())
                                .addNodes(
                                    RecordStoreProtocol.QueryFilterNode.newBuilder()
                    ...
                    RecordStoreProtocol.QueryFilterNode.newBuilder()
                        .setFieldNode(
                            RecordStoreProtocol.QueryFilterFieldNode.newBuilder()
                                ...
                                .addAllTokens(
                                    Arrays.asList(
                                        "MR MEESEEKS LOOK AT ME".toLowerCase().split(" ")))
                                .build())
                        .build())
                .build(),
            -1),
        ...
        Arguments.of(
            RecordStoreProtocol.QueryRequest.newBuilder()
                ...
                .setFilter(
                    RecordStoreProtocol.QueryFilterNode.newBuilder()
                        .setMapNode(
                            RecordStoreProtocol.QueryFilterMapNode.newBuilder()
                                .setField("favorite_locations_from_tv")
                                .setKey(
                                    RecordStoreProtocol.QueryFilterFieldNode.newBuilder()
                                        .setOperation(
                                            RecordStoreProtocol.FilterOperation.START_WITH)

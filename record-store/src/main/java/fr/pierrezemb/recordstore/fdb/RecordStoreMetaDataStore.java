...
public class RecordStoreMetaDataStore {
  public static FDBMetaDataStore createMetadataStore(
      FDBRecordContext context, String tenant, String env) {
    FDBMetaDataStore metaDataStore =
        new FDBMetaDataStore(context, RecordStoreKeySpace.openMetaDataKeySpacePath(tenant, env));

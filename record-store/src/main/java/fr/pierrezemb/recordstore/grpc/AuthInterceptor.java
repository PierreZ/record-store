...
public class AuthInterceptor implements ServerInterceptor {
  ...
  private static final Map<Metadata.Key<String>, Context.Key<String>> METADATA_KEY_TO_CONTEXT_KEY =
      ImmutableMap.of(
  ...
  private final List<Metadata.Key<String>> requiredKeys =
      Arrays.asList(
